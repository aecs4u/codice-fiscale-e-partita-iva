...
from codice_fiscale import __description__, __version__, codice_fiscale
...
def _decode_from_args(args: argparse.Namespace) -> None:
    try:
        cf_data = codice_fiscale.decode(args.code)
    except Exception as error:
        sys.stderr.write(f"{error}\n")
    else:
...
def _validate_from_args(args: argparse.Namespace) -> None:
    if codice_fiscale.is_valid(args.code):
        sys.stdout.write("✅\n")
    else:
        sys.stdout.write("❌\n")
...
def run() -> None:
    ...
    decode_parser = subparsers.add_parser(
        ...
        help=(
            ...
            "For more info run: 'python -m codice_fiscale decode --help'"
        ),
    )
    ...
    encode_parser = subparsers.add_parser(
        ...
        help=(
            ...
            "For more info run: 'python -m codice_fiscale encode --help'"
        ),
    )
    ...
    validate_parser = subparsers.add_parser(
        ...
        help=(
            ...
            "For more info run: 'python -m codice_fiscale validate --help'"
        ),
    )
...
def run_with_args(args: argparse.Namespace) -> None:
    if args.subcommand is None and args.version:
        ...
        sys.stdout.write("For more info run: 'python -m codice_fiscale --help'\n")
